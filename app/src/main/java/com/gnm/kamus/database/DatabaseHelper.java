...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static String DATABASE_NAME = "dbkamus.db";

    public static String TABLE_ENGLISH = "tbl_english";
    public static String TABLE_INDONESIA = "tbl_indonesia";

    public static String FIELD_ID = "id";
    public static String FIELD_WORD = "kata";
    public static String FIELD_TRANSLATE = "terjemahan";
